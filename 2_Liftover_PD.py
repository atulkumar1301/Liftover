...
# data1 = pd.read_csv("/Users/akumar/Library/CloudStorage/OneDrive-UniversityofEasternFinland/Projects/Genetic_Data_QC/FinnHap550/Splitted_CHR/23.txt", delimiter="\t")
# data2 = pd.read_csv("/Users/akumar/Library/CloudStorage/OneDrive-UniversityofEasternFinland/Data/dbSNP_GB_38/All_20180418_X.vcf.gz", delimiter="\t", compression='gzip', on_bad_lines='skip', comment='#',
# names=["CHROM", "POS", "ID", "REF", "ALT", "QUAL", "FILTER", "INFO"])
# df = pd.merge(data1, data2, how='inner', on='ID')
# df.to_csv ("/Users/akumar/Library/CloudStorage/OneDrive-UniversityofEasternFinland/Projects/Genetic_Data_QC/FinnHap550/Merged_CHR/SNP_Merged_X.txt", sep="\t", index=False)
